...
def get_options(parser: ArgumentParser, reset_args=None):
    ...
    if reset_args is None:
        reset_args = {}
    datasets = ('tmall', 'alipay', 'taobao', 'MQ2007')
    ...
    parser.add_argument('-cm', '--click_model', type=str, choices=['', 'UBM', 'PBM', 'CCM'], default='')
    ...
    parser.add_argument('--data_dir', type=str, default='./SlideData')
